    ...
    <div className="py-[48px] lg:py-[60px]">
      ...
      <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
        <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
          ...
          <button className="mt-[16px] rounded-[4px] bg-white py-[14px] text-[#4328EB] font-medium transform transition-transform duration-300 hover:scale-105">
            Start Trial
          </button>
        </div>
        ...
        <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
          ...
          <button className="mt-[16px] rounded-[4px] bg-white py-[14px] text-[#4328EB] font-mediumtransform transition-transform duration-300 hover:scale-105">
            Contact Us
          </button>
        </div>
      </div>

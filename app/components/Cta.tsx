...
export function Cta() 
{
     return (
        ...
        <div className="mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row lg:justify-center gap-x-[40px]">
          <button className="py-[16px] px-[32px] bg-white rounded-[4px] text-pink-500 w-fit font-medium transform transition-transform duration-300 hover:scale-110">
            Try for free
          </button>
  
          <button className="flex w-full items-center justify-center font-medium gap-x-3 mt-[32px] text-white font-medium transform transition-transform duration-300 hover:scale-110 lg:w-fit lg:mt-0 ">
            Contact Sales{" "}
            <span>
